...
public class PuzzleArrayAdapter extends ArrayAdapter<Puzzle> {
    ...
    public PuzzleArrayAdapter(Context context, ArrayList<Puzzle> values) {
        super(context, R.layout.puzzles_list_item_layout, values);
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        final Puzzle puzzle = puzzles.get(position);
        ...
        View.OnClickListener onClickMe = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, DisplayPuzzleActivity.class);
                Bundle bundle = new Bundle();
                bundle.putSerializable("SERIALIZED_OBJ", puzzle.getSerialized());
        ...
        View rowView = inflater[0].inflate(R.layout.puzzles_list_item_layout, parent, false);
        TextView title_tv = rowView.findViewById(R.id.puzzle_list_item_title_tv);
        final TextView votes_tv = rowView.findViewById(R.id.puzzle_list_item_votes_tv);
        TextView desc_tv = rowView.findViewById(R.id.puzzle_list_item_desc_tv);
        final ImageButton upvote_btn = rowView.findViewById(R.id.puzzle_list_item_upvote_btn);
        final ImageButton downvote_btn = rowView.findViewById(R.id.puzzle_list_item_downvote_btn);

        voted[0] = tempVoted[0] = puzzle.getVoted();
        if (voted[0]==1) {
        ...
        votes_tv.setText(puzzle.getListItemVotes());
